...
public EmployeeInterface getEmployeeByEmployeeId(String employeId)throws BLException;
...
public boolean designationAlloted(int designaitonCode)throws BLException;
}